...
const animatedBlogTitle = document.querySelector(".js-animation-blog-title");
...
function displayBlogTitle(){
    setTimeout( () => animatedBlogTitle.children[0].classList.add('js-visible'), 0);
    setTimeout( () => animatedBlogTitle.children[1].classList.add('js-visible'), 200);
}
